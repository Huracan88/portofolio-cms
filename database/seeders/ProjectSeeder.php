    ...
    public function run(): void
    {
        $projects = [
            [
                ...
                'image_url' => 'images/projects/fallback.jpg',
                'project_url' => null,
                'repo_url' => null,
                'sector' => 'government',
                'is_featured' => false,
                ...
                'sort_order' => 1,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'REST APIs', 'Linux', 'Docker'],
            ],
            [
                ...
                'image_url' => 'images/projects/cadastre.jpg',
                'project_url' => null,
                'repo_url' => null,
                'sector' => 'government',
                'is_featured' => true,
                ...
                'sort_order' => 2,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'PostgreSQL', 'jQuery', 'Bootstrap'],
            ],
            [
                ...
                'sort_order' => 3,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'REST APIs', 'Linux', 'Nginx'],
            ],
            [
                ...
                'sort_order' => 4,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'Microsoft SQL Server', 'Advanced Excel'],
            ],
            [
                ...
                'sort_order' => 5,
                'skills' => ['PHP', 'MySQL / MariaDB', 'jQuery', 'Bootstrap', 'REST APIs'],
            ],
            [
                ...
                'image_url' => 'images/projects/payroll.jpg',
                'project_url' => null,
                'repo_url' => null,
                'sector' => 'enterprise',
                'is_featured' => true,
            ...
            [
                ...
                'image_url' => 'images/projects/courier.jpg',
                'project_url' => null,
                'repo_url' => null,
                'sector' => 'enterprise',
                'is_featured' => true,
                ...
                'sort_order' => 7,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'REST APIs', 'Docker', 'Nginx', 'jQuery'],
            ],
            [
                ...
                'sort_order' => 8,
                'skills' => ['PHP', 'Laravel', 'Flutter', 'MySQL / MariaDB', 'Tailwind CSS', 'Alpine.js'],
            ],
            [
                ...
                'sort_order' => 9,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'Linux', 'REST APIs', 'Docker'],
            ],
            [
                ...
                'sort_order' => 10,
                'skills' => ['PHP', 'Laravel', 'MySQL / MariaDB', 'REST APIs', 'Docker', 'Linux', 'Nginx'],
            ],
        ];
        ...
        foreach ($projects as $projectData) {
            ...
            $projectData['slug'] = Str::slug($projectData['title_en']);
            $project = Project::updateOrCreate(
                ['slug' => $projectData['slug']],
                $projectData
            );

            $skillIds = Skill::whereIn('name_en', $skillNames)->pluck('id');
