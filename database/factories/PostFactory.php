...
class PostFactory extends Factory
{
    ...
    private static array $posts = [
        ...
        [
            ...
            'excerpt_es' => 'Guía completa de testing con Pest: tests unitarios, de integración, de APIs y tests deFilament con cobertura realista.',
    ...
    {
        $post = self::$posts[self::$postIndex % count(self::$posts)];
        self::$postIndex++;

        $post['slug'] = Str::slug($post['title_en']);
        $post['author_id'] = User::factory();
        $post['category_id'] = Category::factory();
    ...
    public function configure(): static
    {
        return $this->afterCreating(function (Post $post) {
            $tagIds = Tag::inRandomOrder()->take(fake()->numberBetween(2, 4))->pluck('id');
